...
Devise.setup do |config|
  ...
  config.cas_base_url = "http://localhost:7777"
  config.cas_create_user = true
  # config.router_name = :main_app 

  #*****************CAS CLIENT CONFIGURATION ENDS******************
  # The secret key used by Devise. Devise uses this key to generate
  # random tokens. Changing this key will render invalid all existing
  # confirmation, reset password and unlock tokens in the database.
  # Devise will use the `secret_key_base` on Rails 4+ applications as its `secret_key`
  # by default. You can change it below and use your own secret key.
  # config.secret_key = 'bd67aa7724a8c5198b477ccbb631004f6dff94593d353e6d3ccdfe968f4613f40a034db139b2c7d987a1f75df51be8b162965ba2649631f25d6c44a2a1dfb367'
  ...
  # config.pepper = 'caf09b6b8fd1f5383cd2144d49fdbaa6e5e1077743e7b759852dd710715dedb3493b363c51be5cc5b8e8b00bc82eb826060494221a06cf393e1cfd3e987ce727'
